package com.example.home_widget_ex
...
class HomeWidgetExample : HomeWidgetProvider() {
    override fun onUpdate(
        ...
        appWidgetIds.forEach { widgetId ->
            val views = RemoteViews(context.packageName, R.layout.home_widget_ex).apply {
                ...
                val btnIntent = HomeWidgetBackgroundIntent.getBroadcast(
                    context,
                    Uri.parse("homeWidgetExample://titleclicked")
                )
                setOnClickPendingIntent(R.id.incrementBTN, btnIntent)
